...
exports.crawlLottery3D = exports.crawlSuperLotto = exports.crawlDoubleColorBall = void 0;
...
const crawlDoubleColorBall = async () => {
    try {
        const response = await axios_1.default.get(`${BASE_URL}/ssq/kjgg/`, {
            headers: {
...
const crawlSuperLotto = async () => {
    try {
        const response = await axios_1.default.get(`${BASE_URL}/dlt/kjgg/`, {
            headers: {
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36',
                'Referer': BASE_URL
            },
...
const crawlLottery3D = async () => {
    try {
        const response = await axios_1.default.get(`${BASE_URL}/3d/kjgg/`, {
            headers: {
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36',
                'Referer': BASE_URL
            },
