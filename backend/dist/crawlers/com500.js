...
exports.crawlLottery3D500 = exports.crawlSuperLotto500 = exports.crawlDoubleColorBall500 = void 0;
const axios_1 = __importDefault(require("axios"));
const cheerio_1 = __importDefault(require("cheerio"));
const database_1 = require("../database");
const BASE_URL = 'https://kaijiang.500.com';
const crawlDoubleColorBall500 = async () => {
    try {
        const response = await axios_1.default.get(`${BASE_URL}/ssq.shtml`, {
            headers: {
...
exports.crawlDoubleColorBall500 = crawlDoubleColorBall500;
const crawlSuperLotto500 = async () => {
    try {
        const response = await axios_1.default.get(`${BASE_URL}/dlt.shtml`, {
            headers: {
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36',
                'Referer': BASE_URL
            },
...
exports.crawlSuperLotto500 = crawlSuperLotto500;
const crawlLottery3D500 = async () => {
    try {
        const response = await axios_1.default.get(`${BASE_URL}/3d/`, {
            headers: {
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36',
                'Referer': BASE_URL
            },
...
exports.crawlLottery3D500 = crawlLottery3D500;
